...
<template>
  <div class="bg-neutral-300 dark:bg-neutral-700">
    <div class="w-[90%] pt-20 mx-auto flex justify-center items-center">
      <div class="h-150 flex justify-center items-center gap-x-10">
